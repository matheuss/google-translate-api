...
```
npm install --save google-translate-free
```
...
- `from` *(object)*
  - `language` *(object)*
    ...
    - `iso` *(string)* - The [code of the language](https://github.com/matheuss/google-translate-free/blob/master/languages.js) that the API has recognized in the `text`
  - `text` *(object)*
